...
var PageObject_Welcome = (function () {
    ...
    PageObject_Welcome.prototype.openAlertDialog = function () {
        var _this = this;
        return protractor_1.browser.wait(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pressSubmitButton()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, protractor_1.browser.wait(protractor_1.ExpectedConditions.alertIsPresent(), 5000)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, protractor_1.browser.switchTo().alert().then(
