...
module.exports = {
  scripts: {
    ...
    ssr: 'nodemon -L --watch server/index.ts --watch server/ssr-router.ts --watch server/build.ts --watch server/aurelia-ssr.ts --watch server/serve.ts --watch server/interfaces.ts --exec "ts-node server/index"'
  },
}